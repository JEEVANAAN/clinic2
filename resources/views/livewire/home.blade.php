    ...
    <div class=" bg-[#DCEAC6]"><!--bg color-->
        ...
        <div class="container px-5  mx-auto md:px-0 lg:px-20">
            ...
            <header class="md:flex justify-between items-center hidden ">
                ...
                <!-- button -->
                <div class="">
                    <a href="/app"><button class="text-black px-6  bg-[#A4CB6A] font-semibold mb-6 w-full text-center py-3 rounded-lg border-[#212245] border-t border-r-4 border-b-4 border-l">Book an Appointment</button></a>
                </div>
            ...
            <div class="md:flex justify-center items-center md:text-center"><!--parent start-->
                ...
                <div class="">
                    ...
                    <a a href="/app" class="pt-8 pb-2">
                        <button
                        class="text-black w-full md:w-1/2   bg-[#A4CB6A] font-semibold mb-6  text-center py-3 rounded-lg border-[#212245] border-t border-r-4 border-b-4 border-l">Book Your Online Consultation Now</button>
                        </div>
                    ...
                    <div class="mt-10 md:mt-0">
                        ...
                        <div class=" border-[#878787] border border-t-0 px-5   mb-4  rounded-b-lg ">
                            ...
                            <div class=" flex justify-center mt-8">
                                <button
                                class="text-black md:w-5/6 bg-[#A4CB6A] font-semibold mb-6 w-full text-center py-3 rounded-lg border-[#212245] border-t border-r-4 border-b-4 border-l">Book With Dr. Emanuel</button>
                            </div>
                        </div>
                    ...
                    <div class="">
                        ...
                        <div class="border-[#878787] border border-t-0 px-5  mb-4 rounded-b-lg ">
                            ...
                            <p class="text-[#878787] pt-5">He is a board-certified physician with over 15 years of
                                ...
                                <div class=" flex justify-center mt-8">
                                    <button
                                    class="text-black md:w-5/6 bg-[#A4CB6A] font-semibold mb-6 w-full text-center py-3 rounded-lg border-[#212245] border-t border-r-4 border-b-4 border-l">Book With Dr. Jessica</button>
                                </div>
                        </div>
