        ...
        <div class=" container px-5 my-5 mx-auto">
            ...
            <div class=" border border-[#878787] shadow-[0px_1px_3px_0px_rgba(0,0,0,0.16)] rounded-lg py-6 px-5 mt-6">
                ...
                <div class=" flex items-center justify-between mt-7">
                    ...
                    <span class=" text-sm font-semibold">{{$doctor_name->name}}</span>
                </div>
                <div class=" flex items-center justify-between mt-4">
                    ...
                    <span class=" text-sm font-semibold">{{(session('this.date'))}}</span>
                </div>
                <div class=" flex items-center justify-between mt-4">
                    <div class=" flex items-center gap-1.5">
                    ...
                    <span class=" text-sm font-semibold">{{date("h:i A",strtotime(session('this.time')))}}</span>
                </div>
            </div>
            ...
            <div class=" border border-[#878787] shadow-[0px_1px_3px_0px_rgba(0,0,0,0.16)] rounded-lg py-6 px-5 mt-7">
                ...
                <div class=" flex items-center justify-between md:gap-x-2 mt-7">
                    ...
                    <span class=" text-sm font-semibold">{{$patients_details->full_name}}</span>
                </div>
                <div class=" flex items-center justify-between md:gap-x-2 mt-4"> 
                    ...
                    <span class=" text-sm font-semibold">{{$patients_details->email}}</span>
                </div>
                <div class=" flex items-center justify-between md:gap-x-2 mt-4">
                    <div class=" flex items-center gap-1.5">
                    ...
                    <div class=" text-sm font-semibold">+91 {{$patients_details->phone_number}}</div>
                </div>
            </div>
            ...
            <div class=" border border-[#878787] shadow-[0px_1px_3px_0px_rgba(0,0,0,0.16)] rounded-lg py-6 px-5 mt-7">
                ...
                <p class=" text-sm font-normal mt-7">{{$consultations->health_concerns}}</p>
            </div>
            ...
            <div class=" flex justify-center mt-10 lg:mt-40">
                ...
                class="text-black lg:w-[40%] bg-[#A4CB6A] font-semibold mb-6 w-full text-center py-3 rounded-lg border-[#212245] border-t border-r-4 border-b-4 border-l">Confirm & Pay</button>
            </div>
            <!-- Button section end  -->
        </div>
    </main>
